    ...
    return (
        <div>
                ...
                {selectedCourses.map((course) =>(           
                   <ol  key={course.id}>
                     <li className="text-lg text-gray-500 pb-2">{course.title}</li>
                   </ol>
                ))}

                <hr />
                <p className="text-xl pb-2">Total Credit Hour: {totalCredit} hr</p>
                <hr />
                <p className="text-xl pb-2">Total Price:</p>
        </div>
    );
};
